    ...
    class Polygon : Shape
    {
        ...
        public override Point massCenter()
        {
            ...
            for (int i=1; i < list.Count; ++i)
            {
                ...
                res.x += (tr_area_top / square) * tr_center_top.x;
                res.y += (tr_area_top / square) * tr_center_top.y;
                ...
                res.x += (tr_area_bot / square) * tr_center_bot.x;
                res.y += (tr_area_bot / square) * tr_center_bot.y;
            }
            return res;
        }
